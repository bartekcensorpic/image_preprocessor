...
def create_csv(output_path, annots_folder_path, nude_img_folder_path, non_nude_img_folder_path):
    ...
    nude_train_df, nude_val_df, nude_test_df = process_nude_images(columns, annots_folder_path, nude_img_folder_path)

    sfw_train_df, sfw_val_df, sfw_test_df = process_sfw_images(columns, non_nude_img_folder_path)
